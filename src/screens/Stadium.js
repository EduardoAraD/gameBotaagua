                ...
                <ImageBackground source={screnFundo}
                    ...
                    <ScrollView>
                        <View style={styles.areaContent}>
                            <Text style={styles.title}>Estádio</Text>
                            <Text style={styles.title}>36</Text>
                            <ItemIncrement title='Qualidade do Campo' />
                            <ItemIncrement title='Arquibancada'/>
                            <ItemIncrement title='Lanchonetes'/>
                            <ItemIncrement title='Estacionamento'/>
                            <ItemIncrement title='Placar'/>
